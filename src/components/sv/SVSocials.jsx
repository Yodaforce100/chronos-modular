      ...
      <div className="max-w-2xl mx-auto px-6 text-center">
        ...
        >
          {SOCIALS.map((social, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-white border border-[#001C5F] flex items-center justify-center text-[#C9A84C] shadow-sm group-hover:border-[#D9B86A] group-hover:text-[#D9B86A] transition-all duration-300">
                {social.icon}
              </div>
