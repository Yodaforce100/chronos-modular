  ...
  return (
    <div className="flex items-center gap-0.5" aria-hidden="true">
      {[1, 2, 3, 4, 5, 6, 7].map((i) => (
        <div
          key={i}
          className="w-0.5 bg-[#CF9D3E] rounded-full animate-soundwave"
          style={{
...
export default function SVHero({ onCTAClick }) {
  return (
    <section className="relative min-h-[70vh] flex flex-col justify-center overflow-hidden pt-44 pb-8">
      ...
      >
        <img
          ...
          style={{ opacity: 0.72, filter: "contrast(1.15) saturate(1.1)" }}
        />
