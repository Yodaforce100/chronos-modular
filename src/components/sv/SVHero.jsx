      ...
      <div className="max-w-3xl mx-auto px-6 w-full flex flex-col items-center text-center py-4 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-8 flex-wrap justify-center">
            <SoundwaveBars />
            <span className="font-sans text-sm font-medium text-[#5E8DBF] tracking-widest uppercase">
          ...
          <button
            onClick={onCTAClick}
            className="mt-10 font-sans text-[15px] font-medium text-[#669eea] px-8 py-4 rounded-full min-h-[44px] shadow-md transition-opacity duration-300 hover:opacity-90"
