...
export default function SVHowItWorks() {
  return (
    <section id="how-it-works" className="relative pt-2 pb-10 md:pt-8 md:pb-20" style={{ background: "linear-gradient(to bottom, rgba(249,248,246,0.5) 0%, rgba(255,255,255,1) 50%)" }}>
