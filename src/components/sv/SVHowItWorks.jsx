...
export default function SVHowItWorks() {
  return (
    <section id="how-it-works" className="relative pt-2 pb-10 md:pt-8 md:pb-20 bg-white" style={{ backgroundImage: "linear-gradient(to bottom, #F2F1EE 0%, rgba(255,255,255,0) 25%)" }}>
