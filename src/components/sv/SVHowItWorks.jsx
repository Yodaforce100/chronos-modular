...
const STEPS = [
  {
    ...
    overlayImage: "https://media.base44.com/images/public/69e96f879840c600a93d0ce5/0267ecb87_generated_image.png",
  },
  {
    number: "02",
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          <h2 className="font-serif text-2xl md:text-3xl lg:text-[32px] leading-[1.25] text-[#001C5F]">
            Two simple steps<br /><span className="text-xl md:text-2xl lg:text-[24px]">A day transformed</span>
          </h2>
        </motion.div>
                ...
                <div className="relative w-full h-56 md:h-64 overflow-hidden">
                  ...
                  {step.overlayImage && (
                    <img
                      ...
                      alt=""
                      className="absolute"
                      style={{ top: "5%", left: "28%", width: "44%", borderRadius: "10px", pointerEvents: "none" }}
                    />
                  )}
