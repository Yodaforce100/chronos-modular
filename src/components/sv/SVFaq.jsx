...
export default function SVFaq() {
  ...
  return (
    <section className="relative py-10 md:py-20 bg-white">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none" style={{ backgroundImage: "url('https://media.base44.com/images/public/69e96f879840c600a93d0ce5/1fb038157_istockphoto-1850234180-1024x1024.jpg')", backgroundSize: "cover", backgroundPosition: "center", filter: "saturate(0.6) brightness(1.1) grayscale(0.1)" }} />
      {/* Fade in from top */}
