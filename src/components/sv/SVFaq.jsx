...
export default function SVFaq() {
  ...
  return (
    <section className="relative py-10 md:py-20 bg-white">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none" style={{ backgroundImage: "url('https://media.base44.com/images/public/69e96f879840c600a93d0ce5/655c7dd1f_istockphoto-465146337-1024x1024.jpg')", backgroundSize: "contain", backgroundPosition: "center center", backgroundRepeat: "no-repeat", filter: "saturate(0.7) brightness(1.05)" }} />
      {/* Fade in from top */}
