...
export default function SVFaq() {
  ...
  return (
    <section className="relative py-10 md:py-20 bg-white">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none" style={{ backgroundImage: "url('https://media.base44.com/images/public/69e96f879840c600a93d0ce5/a7773bfcc_istockphoto-1164883816-1024x1024.jpg')", backgroundSize: "cover", backgroundPosition: "30% center", filter: "saturate(0.7) brightness(1.05)" }} />
      {/* Fade in from top */}
