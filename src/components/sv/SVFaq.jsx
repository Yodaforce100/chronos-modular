...
export default function SVFaq() {
  ...
  return (
    <section className="relative py-10 md:py-10 bg-white">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none hidden md:block" style={{ backgroundImage: "url('https://media.base44.com/images/public/69e96f879840c600a93d0ce5/dcaf9fcc8_istockphoto-1164883816-1024x1024.jpg')", backgroundSize: "80%", backgroundPosition: "5% center", backgroundRepeat: "no-repeat", filter: "saturate(0.7) brightness(1.05)" }} />
