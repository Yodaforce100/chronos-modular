...
const MOODS = [
  { emoji: "😔", label: "Heavy", color: "#D4A843" },
  { emoji: "😟", label: "Anxious", color: "#D4A843" },
  { emoji: "😌", label: "Peaceful", color: "#D4A843" },
  { emoji: "😴", label: "Tired", color: "#D4A843" },
  { emoji: "🙏", label: "Grateful", color: "#243E6B" },
  { emoji: "😊", label: "Hopeful", color: "#D4A843" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="bg-white rounded-[24px] border border-[#E7DED2] p-8 shadow-sm">
              <p className="font-sans text-xs font-medium text-[#D4A843] tracking-widest uppercase mb-5">
              ...
              <div className="mt-6 pt-6 border-t border-[#E7DED2]">
                <p className="font-sans text-xs text-[#D4A843] tracking-wide mb-2">
          ...
          >
            <span className="font-sans text-xs font-medium text-[#D4A843] tracking-widest uppercase block mb-5">
              The Why
            </span>
            ...
            <div className="w-12 h-[1.5px] bg-[#D4A843] my-6" />
