...
const MOODS = [
  ...
  { emoji: "😟", label: "Anxious", color: "#A9C3D6" },
  { emoji: "😌", label: "Peaceful", color: "#A9C3D6" },
  { emoji: "😴", label: "Tired", color: "#A9C3D6" },
  { emoji: "🙏", label: "Grateful", color: "#001c5f" },
  { emoji: "😊", label: "Hopeful", color: "#A9C3D6" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="bg-white rounded-[24px] border border-[#E7DED2] p-4 md:p-8 shadow-sm">
              <p className="font-sans text-xs font-medium text-[#A9C3D6] tracking-widest uppercase mb-5">
              ...
              <div className="mt-6 pt-6 border-t border-[#E7DED2]">
                <p className="font-sans text-xs text-[#A9C3D6] tracking-wide mb-2">
