...
export default function SVConnection() {
  return (
    <section className="relative py-6 pb-14 md:py-10 md:pb-20" style={{ backgroundImage: "linear-gradient(to bottom, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.4) 40%, rgba(242,241,238,0) 100%), url('https://media.base44.com/images/public/69e96f879840c600a93d0ce5/115a2afc0_generated_image.png')", backgroundSize: "cover, cover", backgroundPosition: "center, center" }}>
