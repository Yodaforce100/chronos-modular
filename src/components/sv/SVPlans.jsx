            ...
            >
              ...
              {plan.badge && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span className="font-sans text-[11px] font-semibold text-white bg-[#6B8F71] px-4 py-1.5 rounded-full whitespace-nowrap shadow">
                    {plan.badge}
                  </span>
                </div>
              )}
                    ...
                    <li key={feat} className="flex items-start gap-3">
                      <div
                        className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${
                          plan.featured ? "bg-[#6B8F71]" : "bg-[#A9C3D6]/30"
                        }`}
                      >
