          ...
          {PLANS.map((plan, i) => (
            ...
            >
              ...
              <button
                ...
                style={plan.featured ? { background: "linear-gradient(90deg, #C9A84C 0%, #F5E9A4 35%, #E8D48B 60%, #C9A84C 100%)", boxShadow: "0 4px 14px rgba(212,185,106,0.4)", textShadow: "0 1px 3px rgba(0,0,0,0.35)" } : {}}
              >
                {plan.cta}
              </button>
            </motion.div>
